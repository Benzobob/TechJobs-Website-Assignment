...
<script>
	function DeleteVacancy(x)
      {	
			...
			{
				var str1 = "DeleteVacancyForCompany.php?vid=";
...
<div class="container">
  <div class="row">
    <div class="col-3"></div>
	<div class="col-6">
	<h3 style="text-align:center;">Vacancies</h3>
	<ul class="list-group">
		<?php 
		include "config/connection.php";
		if(isset($_SESSION['compID'])){
			$cid = $_SESSION['compID'];
			$sql = "SELECT * FROM Vacancies WHERE CompanyID = $cid";
			$result = $conn->query($sql);
			echo "<div class='container'><table class='table table-striped'>";
			while($row = $result->fetch_assoc()) {
				echo "<tr>";
				echo "<td><a href='VacancyPage.php?vid=" . $row['VID'] . "'>" .  $row['VTitle'] . "</a></td>";
				echo "<td><a style='cursor: pointer;' onclick='DeleteVacancy(" . $row['VID'] . ")'><i class='material-icons'>delete</i></a></td>";
			}
		}
		echo "</tr>";
		?>
